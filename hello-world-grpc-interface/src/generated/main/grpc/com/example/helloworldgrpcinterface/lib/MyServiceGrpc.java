package com.example.helloworldgrpcinterface.lib;
...
public final class MyServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.helloworldgrpcinterface.lib.HelloRequest,
      com.example.helloworldgrpcinterface.lib.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.example.helloworldgrpcinterface.lib.HelloRequest.class,
      responseType = com.example.helloworldgrpcinterface.lib.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.helloworldgrpcinterface.lib.HelloRequest,
      com.example.helloworldgrpcinterface.lib.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.example.helloworldgrpcinterface.lib.HelloRequest, com.example.helloworldgrpcinterface.lib.HelloResponse> getSayHelloMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getSayHelloMethod = MyServiceGrpc.getSayHelloMethod) == null) {
          MyServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.example.helloworldgrpcinterface.lib.HelloRequest, com.example.helloworldgrpcinterface.lib.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.helloworldgrpcinterface.lib.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.helloworldgrpcinterface.lib.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(com.example.helloworldgrpcinterface.lib.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.helloworldgrpcinterface.lib.HelloResponse> responseObserver) {
  ...
  public static final class MyServiceStub
    ...
    /**
     */
    public void sayHello(com.example.helloworldgrpcinterface.lib.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.helloworldgrpcinterface.lib.HelloResponse> responseObserver) {
  ...
  public static final class MyServiceBlockingStub
    ...
    /**
     */
    public com.example.helloworldgrpcinterface.lib.HelloResponse sayHello(com.example.helloworldgrpcinterface.lib.HelloRequest request) {
  ...
  public static final class MyServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.helloworldgrpcinterface.lib.HelloResponse> sayHello(
        com.example.helloworldgrpcinterface.lib.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.example.helloworldgrpcinterface.lib.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.example.helloworldgrpcinterface.lib.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.helloworldgrpcinterface.lib.HelloRequest,
              com.example.helloworldgrpcinterface.lib.HelloResponse>(
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.helloworldgrpcinterface.lib.HelloWorldProto.getDescriptor();
    }
